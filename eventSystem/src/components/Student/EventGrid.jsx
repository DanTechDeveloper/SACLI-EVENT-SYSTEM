          ...
          >
            ...
            <div className="relative aspect-video overflow-hidden">
              <img
                ...
                src={event.event_image ? (event.event_image.startsWith("http") ? event.event_image : `http://localhost/IPTFINALPROJECT/eventSystem/src/${event.event_image}`) : "https://via.placeholder.com/400x200?text=No+Image"}
              />
