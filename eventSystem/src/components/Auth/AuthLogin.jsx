...
export default function AuthLogin() {
  ...
  return (
    <>
      <div className="w-full flex items-center justify-center bg-background-light dark:bg-background-dark p-6 md:p-6">
        <div className="w-full max-w-md bg-white dark:bg-[#1a202c] shadow-xl rounded-xl p-8 space-y-3">
          ...
          <div className="space-y-6" id="login-container">
            ...
            <form className="space-y-4" onSubmit={handleLoginForm}>
              <div className="space-y-2">
                <label className="block">
                  <span className="text-[#111318] dark:text-gray-200 text-sm font-semibold mb-2 block">
                    Email
                  </span>
                  <input
                    className="w-full rounded-lg border border-[#dbdee6] dark:border-gray-700 dark:bg-gray-800 dark:text-white h-12 px-4 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-gray-400"
                    type="email"
                    id="loginEmail"
              ...
              <div className="space-y-2">
                <label className="block relative">
                  ...
                  <div className="relative">
                    <input
                      className="w-full rounded-lg border border-[#dbdee6] dark:border-gray-700 dark:bg-gray-800 dark:text-white h-12 px-4 pr-12 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-gray-400"
                      type="password"
                      id="loginPassword"
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-white dark:bg-gray-800 border border-[#dbdee6] dark:border-gray-700 text-[#111318] dark:text-white font-semibold py-3 px-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-all flex items-center justify-center gap-2"
              >
