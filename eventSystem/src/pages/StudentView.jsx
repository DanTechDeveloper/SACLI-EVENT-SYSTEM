export default function StudentView() {
  return (
    // &lt;&gt;
    <div class="flex gap-4 p-4 flex-col mt-[20px] ml-[30px] w-full">
      <h1 class="text-gray-900 text-4xl font-black">
        Announcement &amp; Event
      </h1>
            ...
            <div class="flex flex-[2_2_0px] flex-col gap-3">
              <div class="flex flex-col gap-1.5">
                ...
                <p class="text-gray-600 dark:text-gray-300 text-sm font-normal leading-normal">
                  ...
                  for all departments has been released. Please review the dates
