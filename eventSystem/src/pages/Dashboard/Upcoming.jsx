    ...
    <>
      <div class="flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-6 mt-6">
          <p class="text-[#212529] dark:text-white text-2xl font-black leading-tight tracking-[-0.033em]">
            This Week, Month, & Year’s Upcoming Events
          </p>
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div class="flex flex-col gap-2 rounded-xl p-6 border border-slate-200 bg-white dark:bg-slate-900 dark:border-slate-800">
              ...
              <p class="text-[#212529] dark:text-white tracking-light text-3xl font-bold leading-tight"></p>
            </div>
            <div class="flex flex-col gap-2 rounded-xl p-6 border border-slate-200 bg-white dark:bg-slate-900 dark:border-slate-800">
              <p class="text-[#6C757D] dark:text-slate-400 text-base font-medium leading-normal whitespace-nowrap">
